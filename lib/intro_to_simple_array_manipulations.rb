...
def using_pop(britney)
  britney.pop
end

def pop_with_args(janet)
  janet.pop(2)
end 

def using_shift(alanis)
  alanis.shift
end

def shift_with_args(whitney)
  whitney.shift(2)
end
...
def using_delete_at(rocket, robocop)
  rocket.delete(robocop)
end  